...
@Service()
export default class Migration_logRepository implements IRepository,IService {
    ...
    public getMigrationLog(): Promise<IMigrationLog[]> {
        return new Promise((resolve, reject) => {
            this.storageSrv.db["all"]("select * from migration_log", (err: any, logs: IMigrationLog[]) => {
